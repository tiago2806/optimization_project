...
def arithmetic_crossover(parent1, parent2):
    ...
    Parameters:
    - parent1 -> list: First parent solution, represented as a vector of weights and biases.
    - parent2 -> list: Second parent solution, represented as a vector of weights and biases.

    ------------
    Output
    -> Tuple: Two child solutions generated by combining the two parents.
    '''
...
def blend_crossover(parent1, parent2, alpha = 0.3):
    ...
    This operator is suitable for continuous optimization problems because each child gene is sampled from an interval around the values of the corresponding parent genes.
    ...
    - parent1 -> list: First parent solution, represented as a vector of weights and biases.
    - parent2 -> list: Second parent solution, represented as a vector of weights and biases.
    - alpha -> float: determines how much the offspring can extend beyond the parents values.
